...
kayran@KVChaves:~$ cat linguagens.txt
Python, PHP, Java, GDScript

kayran@KVChaves:~$ cat idiomas.txt
Português, Inglês

kayran@KVChaves:~$ cat tecnologias.txt
FastAPI, Spring Boot, PostgreSQL

kayran@KVChaves:~$ cat devops.txt
